  ...
  render(){
    return(
      <div id = "adam">
        ...
        <p className ="exec_tags">3rd year Computer Science & Software Engineering Student</p>
  ...
  render(){
    return(
      <div id = "jaser">
        ...
        <p className ="exec_tags">3rd year Neuroscience & Biology Student</p>
  ...
  render(){
    return(
      <div id = "gerardo">
        ...
        <p className ="exec_tags">4th year Accounting & Finance Student</p>
  ...
  render(){
    return(
      <div id = "mopat"> 
        ...
        <p className ="exec_tags">2nd year Computer Science & Software Engineering Student</p>
...
export class MoLa extends React.Component{
  render(){
    return(
      <div id = "mola">
        <h1 id = "exec_title">Mohammed Larya</h1>

        <p className ="exec_tags">2nd year Computer Science Student</p>
