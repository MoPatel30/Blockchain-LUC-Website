...
export class MoPat extends React.Component{
  render(){
    return(
      <div id = "mopat"> 
        <h1 id = "exec_title">Mohammed Patel</h1>
        
        <p className ="exec_tags"><u>2nd year Computer Science & Software Engineering Student</u></p>

        <p id = "exec_desc"><b>Mohammed Patel</b> is currently studying Computer Science and Software Engineering. His passion for technology and innovation began early, due to his early exposure to technology. Mohammed was introduced to the Bitcoin and Blockchain space quite early and has become Interested in the history of Bitcoin and it’s monetary policies. In addition, he has also built and set up miners from computer parts as well as high-functioning gaming PCs. On his free time, Mohammed loves to play video games, read, and build website/small projects. His most recent project is <a href = "https://luc-course-evaluator.app/">https://luc-course-evaluator.app/</a> which is a website for Loyola students to rate/review courses and for other students to view such reveiws.</p>
     
        <p className ="exec_tags">Areas of Interest: Blockchain, Computer Science, web development, Big Tech</p>
...
export class Kev extends React.Component{
  render(){
    return(
      <div id = "kev">
        <h1 id = "exec_title">Kevin Guillaume</h1>
