...
export class Education extends React.Component{
    render(){
        return(
            <div>
                <div className = "blockchain-section" style = {{ backgroundColor: 'white', border: '8px solid maroon', width: '600px', height: '500px',position: 'relative', left: '50px', top: '15px', marginBottom: "25px", fontFamily: 'Open Sans Condensed'}}>
                ...
                <div className = "bitcoin-section" style = {{ backgroundColor: 'white', border: '8px solid maroon', width: '600px', height: '500px', position: 'absolute', right: '50px', top: '166px', marginBottom: "25px", fontFamily: 'Open Sans Condensed'}}>
                ...
                <div id="more-information-resources-section" style = {{ backgroundColor: 'white', border: '8px solid maroon', position: "relative", marginLeft: "50px", marginRight: "50px", marginBottom: "50px",top: "25px",fontFamily: 'Open Sans Condensed'}}>
                    ...
                    <iframe title = "btc video" style = {{position: "relative", left: "100px", marginBottom: "20px", border: "3px solid maroon", width:"507", height:"285", src:"https://www.youtube.com/embed/SSo_EIwHSd4", frameborder:"0", allow: "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture, allowfullscreen"}}></iframe>
                    <iframe title = "blockchain video" style = {{position: "relative", left: "200px", marginBottom: "20px", border: "3px solid maroon", width:"507", height:"285", src:"https://www.youtube.com/embed/L-Qhv8kLESY", frameborder:"0", allow: "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture, allowfullscreen"}}></iframe>
                </div>
            </div>
